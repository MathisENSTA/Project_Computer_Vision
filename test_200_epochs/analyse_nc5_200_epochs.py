...
model = get_model()
checkpoint = torch.load('model_resnet18_final_200_epochs.pth', map_location=device)
...
if agreement > 95:
    ...
    print("CONCLUSION : NC5 est partiel. Le réseau utilise encore des frontières de décision plus complexes que la simple distance.")
print("="*40)